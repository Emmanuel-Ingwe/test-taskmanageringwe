...
//       <SnowfallComponent />
//       <div className="">
//         <h1 className="m-10 text-2xlll text-2xll xl:text-3xl font-bold tracking-wide animate-pulse text-green-600">Merry Christmas <span className='text-red-800'>Shuga</span></h1>
//           <Linearr />
